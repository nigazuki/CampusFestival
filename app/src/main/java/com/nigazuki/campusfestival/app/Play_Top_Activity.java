...
public class Play_Top_Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_top);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            view.findViewById(R.id.list_button).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(Play_Top_Activity.this, "Pushd " + (finalI + 1) ,Toast.LENGTH_SHORT);
                }
            });
